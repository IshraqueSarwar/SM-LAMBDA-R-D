...
public class VirtualScriptEditor : VirtualProgram
{
    ...
    void Start()
    {
        ...
        //Make sure the editor is always hidden initially
    ...
    // We use this function to show all the main UI buttons as we hide the editor.
    public void ResetMainUIButtonVisibility()
    {
        // ??NOTE?? This code below doesn't work... We need to fix this before moving on!!!
        transform.parent.parent.Find("UIButtons").gameObject.SetActive(true);
    }
